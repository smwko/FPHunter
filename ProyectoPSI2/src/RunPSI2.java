...
public class RunPSI2 extends CodigoSQL2{
	...
	private JButton buttonAtras, buttonAtras2, buttonAtras3, buttonAtras4, buttonAtras5;
	
	//Atributos Panel Control
	private JLabel selecionLabel;
	...
	private JButton buttonLlenarArea, buttonLlenarCurso, buttonLlenarCentro, buttonLlenarMunicipio;
	...
	public RunPSI2(){ 
		...
		//Componentes General
		Color color = new Color(140, 192, 222);
		...
		buttonAtras4 = new JButton(new AbstractAction("Atras") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonAtras5 = new JButton(new AbstractAction("Atras") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonAtras.setBackground(color);
		buttonAtras2.setBackground(color);
		buttonAtras3.setBackground(color);
		buttonAtras4.setBackground(color);
		buttonAtras5.setBackground(color);
        ...
        String[] columnM = {"Nombre de Municipio", "Número de Centros", "Porcentaje de Centros"};
        String[] columnC = {"% de Cursos con Certificado", "% de Cursos sin Certificado", "% de Cursos Presenciales", "% de Cursos Telemáticos", "Duración Media de Formación", "Duración Media de Prácticas"};
		...
		selecionLabel = new JLabel();
		selecionLabel.setIcon(new ImageIcon("C:\\Users\\mauv2\\eclipse-workspace\\Proyecto PSI2\\FPHunter.png"));
		...
		estadisticasButton = new JButton(new AbstractAction("Ver Estadísticas de Tablas") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		crearTablasButton.setBackground(color);
		llenarTablasButton.setBackground(color);
		usuarioButton.setBackground(color);
		...
		buttonCrearArea = new JButton(new AbstractAction("Seleccionar") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonCrearCurso = new JButton(new AbstractAction("Seleccionar") {
	        /**
			 * 
			 */
		...
		buttonCrearCentro = new JButton(new AbstractAction("Seleccionar") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonCrearMunicipio = new JButton(new AbstractAction("Seleccionar") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonCrearArea.setBackground(color);
		buttonCrearCurso.setBackground(color);
		buttonCrearCentro.setBackground(color);
		buttonCrearMunicipio.setBackground(color);
		...
		buttonLlenarArea = new JButton(new AbstractAction("Seleccionar") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonLlenarCurso = new JButton(new AbstractAction("Seleccionar") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonLlenarCentro = new JButton(new AbstractAction("Seleccionar") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonLlenarMunicipio = new JButton(new AbstractAction("Seleccionar") {
	        /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		buttonLlenarArea.setBackground(color);
		buttonLlenarCentro.setBackground(color);
		buttonLlenarCurso.setBackground(color);
		buttonLlenarMunicipio.setBackground(color);
		...
		buttonIngresar.setBackground(color);
		...
		panelLlenarTablas.add(buttonLlenarMunicipio);
		panelLlenarTablas.add(labelLlenarArea);
		panelLlenarTablas.add(buttonLlenarArea);
		panelLlenarTablas.add(labelLlenarCentro);
		panelLlenarTablas.add(buttonLlenarCentro);	
		panelLlenarTablas.add(labelLlenarCurso);
		panelLlenarTablas.add(buttonLlenarCurso);
